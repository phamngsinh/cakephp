...
--
-- Host: localhost:3306
-- Generation Time: Sep 21, 2014 at 12:53 AM
...
--
-- Database: `batdongsantudo`
--

-- --------------------------------------------------------

--
-- Table structure for table `dbacos`
--
...
--
-- Dumping data for table `dbacos`
--

INSERT INTO `dbacos` (`id`, `parent_id`, `model`, `foreign_key`, `alias`, `lft`, `rght`) VALUES
...
--
-- Table structure for table `dbaros`
--
...
--
-- Dumping data for table `dbaros`
--

INSERT INTO `dbaros` (`id`, `parent_id`, `model`, `foreign_key`, `alias`, `lft`, `rght`) VALUES
...
--
-- Table structure for table `dbaros_acos`
--

CREATE TABLE `dbaros_acos` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dbaros_acos`
--

INSERT INTO `dbaros_acos` (`id`, `aro_id`, `aco_id`, `_create`, `_read`, `_update`, `_delete`) VALUES
(1, 3, 35, '1', '1', '1', '1'),
(2, 3, 36, '1', '1', '1', '1'),
(3, 2, 37, '1', '1', '1', '1'),
(4, 3, 44, '1', '1', '1', '1'),
...
--
-- Table structure for table `dbblocks`
--

CREATE TABLE `dbblocks` (
...
--
-- Dumping data for table `dbblocks`
--

INSERT INTO `dbblocks` (`id`, `region_id`, `title`, `alias`, `body`, `show_title`, `class`, `status`, `weight`, `element`, `visibility_roles`, `visibility_paths`, `visibility_php`, `params`, `publish_start`, `publish_end`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Dumping data for table `dbcomments`
--

INSERT INTO `dbcomments` (`id`, `parent_id`, `model`, `foreign_key`, `user_id`, `name`, `email`, `website`, `ip`, `title`, `body`, `rating`, `status`, `notify`, `type`, `comment_type`, `lft`, `rght`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Table structure for table `dbcontacts`
--
...
--
-- Dumping data for table `dbcontacts`
--

INSERT INTO `dbcontacts` (`id`, `title`, `alias`, `body`, `name`, `position`, `address`, `address2`, `state`, `country`, `postcode`, `phone`, `fax`, `email`, `message_status`, `message_archive`, `message_count`, `message_spam_protection`, `message_captcha`, `message_notify`, `status`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
INSERT INTO `dblanguages` (`id`, `title`, `native`, `alias`, `status`, `weight`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
INSERT INTO `dblinks` (`id`, `parent_id`, `menu_id`, `title`, `class`, `description`, `link`, `target`, `rel`, `status`, `lft`, `rght`, `visibility_roles`, `params`, `publish_start`, `publish_end`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Table structure for table `dbmenus`
--

CREATE TABLE `dbmenus` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `class` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `dbmenus`
--

INSERT INTO `dbmenus` (`id`, `title`, `alias`, `class`, `description`, `status`, `weight`, `link_count`, `params`, `publish_start`, `publish_end`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Table structure for table `dbmeta`
--
...
--
-- Dumping data for table `dbmeta`
--

INSERT INTO `dbmeta` (`id`, `model`, `foreign_key`, `key`, `value`, `weight`, `created`, `created_by`, `updated`, `updated_by`) VALUES
(1, 'Node', 1, 'meta_keywords', 'key1, key2', NULL, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `dbmodel_taxonomies`
--

CREATE TABLE `dbmodel_taxonomies` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `model` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Node',
...
--
-- Dumping data for table `dbmodel_taxonomies`
--

INSERT INTO `dbmodel_taxonomies` (`id`, `model`, `foreign_key`, `taxonomy_id`) VALUES
(1, 'Node', 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `dbnodes`
--

CREATE TABLE `dbnodes` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `parent_id` int(20) DEFAULT NULL,
  `user_id` int(20) NOT NULL DEFAULT '0',
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `dbnodes`
--

INSERT INTO `dbnodes` (`id`, `parent_id`, `user_id`, `title`, `slug`, `body`, `excerpt`, `status`, `mime_type`, `comment_status`, `comment_count`, `promote`, `path`, `terms`, `sticky`, `lft`, `rght`, `visibility_roles`, `type`, `publish_start`, `publish_end`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Table structure for table `dbregions`
--

CREATE TABLE `dbregions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `dbregions`
--

INSERT INTO `dbregions` (`id`, `title`, `alias`, `description`, `block_count`, `created`, `created_by`, `updated`, `updated_by`) VALUES
(3, 'none', 'none', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(4, 'right', 'right', '', 6, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(6, 'left', 'left', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(7, 'header', 'header', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(8, 'footer', 'footer', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(9, 'region1', 'region1', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(10, 'region2', 'region2', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(11, 'region3', 'region3', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(12, 'region4', 'region4', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(13, 'region5', 'region5', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(14, 'region6', 'region6', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(15, 'region7', 'region7', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(16, 'region8', 'region8', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(17, 'region9', 'region9', '', 0, '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL);
...
INSERT INTO `dbroles` (`id`, `title`, `alias`, `created`, `created_by`, `updated`, `updated_by`) VALUES
...
--
-- Table structure for table `dbroles_users`
--

CREATE TABLE `dbroles_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dbschema_migrations`
--

CREATE TABLE `dbschema_migrations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dbschema_migrations`
--

INSERT INTO `dbschema_migrations` (`id`, `class`, `type`, `created`) VALUES
(1, 'InitMigrations', 'Migrations', '2014-09-20 15:31:26'),
(2, 'ConvertVersionToClassNames', 'Migrations', '2014-09-20 15:31:26'),
(3, 'IncreaseClassNameLength', 'Migrations', '2014-09-20 15:31:26'),
(4, 'FirstMigrationSettings', 'Settings', '2014-09-20 15:31:26'),
(5, 'SettingsTrackableFields', 'Settings', '2014-09-20 15:31:27'),
(6, 'AddedAssetTimestampSetting', 'Settings', '2014-09-20 15:31:27'),
(7, 'ExposeSiteThemeAndLocaleAndHomeUrl', 'Settings', '2014-09-20 15:31:27'),
(8, 'FirstMigrationAcl', 'Acl', '2014-09-20 15:31:27'),
(9, 'FirstMigrationBlocks', 'Blocks', '2014-09-20 15:31:27'),
(10, 'BlocksTrackableFields', 'Blocks', '2014-09-20 15:31:28'),
(11, 'BlocksPublishingFields', 'Blocks', '2014-09-20 15:31:29'),
(12, 'FirstMigrationComments', 'Comments', '2014-09-20 15:31:29'),
(13, 'CommentsTrackableFields', 'Comments', '2014-09-20 15:31:29'),
(14, 'AddCommentsForeignKeys', 'Comments', '2014-09-20 15:31:30'),
(15, 'FirstMigrationContacts', 'Contacts', '2014-09-20 15:31:30'),
(16, 'ContactsTrackableFields', 'Contacts', '2014-09-20 15:31:31'),
(17, 'FirstMigrationMenus', 'Menus', '2014-09-20 15:31:31'),
(18, 'MenusTrackableFields', 'Menus', '2014-09-20 15:31:31'),
(19, 'MenusPublishingFields', 'Menus', '2014-09-20 15:31:32'),
(20, 'FirstMigrationMeta', 'Meta', '2014-09-20 15:31:32'),
(21, 'MetaTrackableFields', 'Meta', '2014-09-20 15:31:33'),
(22, 'FirstMigrationNodes', 'Nodes', '2014-09-20 15:31:33'),
(23, 'NodesTrackableFields', 'Nodes', '2014-09-20 15:31:34'),
(24, 'NodesPublishingFields', 'Nodes', '2014-09-20 15:31:34'),
(25, 'FirstMigrationTaxonomy', 'Taxonomy', '2014-09-20 15:31:35'),
(26, 'TaxonomyTrackableFields', 'Taxonomy', '2014-09-20 15:31:36'),
(27, 'RenameNodesTaxonomy', 'Taxonomy', '2014-09-20 15:31:36'),
(28, 'AddModelTaxonomyForeignKey', 'Taxonomy', '2014-09-20 15:31:36'),
(29, 'AddWysisygEnableField', 'Taxonomy', '2014-09-20 15:31:36'),
(30, 'FirstMigrationUsers', 'Users', '2014-09-20 15:31:36'),
(31, 'UsersTrackableFields', 'Users', '2014-09-20 15:31:37'),
(32, 'UsersEnlargeTimezone', 'Users', '2014-09-20 15:31:37');
...
INSERT INTO `dbsettings` (`id`, `key`, `value`, `title`, `description`, `input_type`, `editable`, `weight`, `params`, `created`, `created_by`, `updated`, `updated_by`) VALUES
(6, 'Site.title', 'Croogo', '', '', '', 1, 1, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(7, 'Site.tagline', 'A CakePHP powered Content Management System.', '', '', 'textarea', 1, 2, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(8, 'Site.email', 'you@your-site.com', '', '', '', 1, 3, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(9, 'Site.status', '1', '', '', 'checkbox', 1, 6, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(12, 'Meta.robots', 'index, follow', '', '', '', 1, 6, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(13, 'Meta.keywords', 'croogo, Croogo', '', '', 'textarea', 1, 7, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(14, 'Meta.description', 'Croogo - A CakePHP powered Content Management System', '', '', 'textarea', 1, 8, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(15, 'Meta.generator', 'Croogo - Content Management System', '', '', '', 0, 9, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(16, 'Service.akismet_key', 'your-key', '', '', '', 1, 11, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(17, 'Service.recaptcha_public_key', 'your-public-key', '', '', '', 1, 12, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(18, 'Service.recaptcha_private_key', 'your-private-key', '', '', '', 1, 13, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(19, 'Service.akismet_url', 'http://your-blog.com', '', '', '', 1, 10, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(20, 'Site.theme', 'RealEstate', '', '', '', 0, 14, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', 1),
(21, 'Site.feed_url', '', '', '', '', 0, 15, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(22, 'Reading.nodes_per_page', '5', '', '', '', 1, 16, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(23, 'Writing.wysiwyg', '1', 'Enable WYSIWYG editor', '', 'checkbox', 1, 17, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(24, 'Comment.level', '1', '', 'levels deep (threaded comments)', '', 1, 18, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(25, 'Comment.feed_limit', '10', '', 'number of comments to show in feed', '', 1, 19, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(26, 'Site.locale', 'eng', '', '', 'text', 1, 20, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(27, 'Reading.date_time_format', 'D, M d Y H:i:s', '', '', '', 1, 21, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(28, 'Comment.date_time_format', 'M d, Y', '', '', '', 1, 22, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(29, 'Site.timezone', 'UTC', '', 'Provide a valid timezone identifier as specified in https://php.net/manual/en/timezones.php', '', 1, 4, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(32, 'Hook.bootstraps', 'Settings,Comments,Contacts,Nodes,Meta,Menus,Users,Blocks,Taxonomy,FileManager,Wysiwyg,Ckeditor', '', '', '', 0, 23, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(33, 'Comment.email_notification', '1', 'Enable email notification', '', 'checkbox', 1, 24, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(34, 'Access Control.multiRole', '0', 'Enable Multiple Roles', '', 'checkbox', 1, 25, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(35, 'Access Control.rowLevel', '0', 'Row Level Access Control', '', 'checkbox', 1, 26, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(36, 'Access Control.autoLoginDuration', '+1 week', '"Remember Me" Duration', 'Eg: +1 day, +1 week. Leave empty to disable.', 'text', 1, 27, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(37, 'Access Control.models', '', 'Models with Row Level Acl', 'Select models to activate Row Level Access Control on', 'multiple', 1, 26, 'multiple=checkbox\noptions={"Nodes.Node": "Node", "Blocks.Block": "Block", "Menus.Menu": "Menu", "Menus.Link": "Link"}', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(38, 'Site.ipWhitelist', '127.0.0.1', 'Whitelisted IP Addresses', 'Separate multiple IP addresses with comma', 'text', 1, 27, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(39, 'Site.asset_timestamp', 'force', 'Asset timestamp', 'Appends a timestamp which is last modified time of the particular file at the end of asset files URLs (CSS, JavaScript, Image). Useful to prevent visitors to visit the site with an outdated version of these files in their browser cache.', 'radio', 1, 28, 'options={"0": "Disabled", "1": "Enabled in debug mode only", "force": "Always enabled"}', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(40, 'Site.admin_theme', '', 'Administration Theme', '', 'text', 1, 29, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(41, 'Site.home_url', '', 'Home Url', 'Default action for home page in link string format.', 'text', 1, 30, '', '2014-09-20 15:31:39', NULL, '2014-09-20 15:31:39', NULL),
(42, 'Croogo.installed', '1', '', '', '', 0, 31, '', '2014-09-20 15:43:00', NULL, '2014-09-20 15:43:00', NULL),
(43, 'Croogo.version', '2.1.0', '', '', '', 0, 32, '', '2014-09-20 15:43:07', NULL, '2014-09-20 15:43:07', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `dbtaxonomies`
--

CREATE TABLE `dbtaxonomies` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `parent_id` int(20) DEFAULT NULL,
...
--
-- Dumping data for table `dbtaxonomies`
--

INSERT INTO `dbtaxonomies` (`id`, `parent_id`, `term_id`, `vocabulary_id`, `lft`, `rght`) VALUES
(1, NULL, 1, 1, 1, 2),
(2, NULL, 2, 1, 3, 4),
(3, NULL, 3, 2, 1, 2);
...
--
-- Table structure for table `dbterms`
--

CREATE TABLE `dbterms` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci,
...
--
-- Dumping data for table `dbterms`
--

INSERT INTO `dbterms` (`id`, `title`, `slug`, `description`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
INSERT INTO `dbtypes` (`id`, `title`, `alias`, `description`, `format_show_author`, `format_show_date`, `format_use_wysiwyg`, `comment_status`, `comment_approve`, `comment_spam_protection`, `comment_captcha`, `params`, `plugin`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Table structure for table `dbtypes_vocabularies`
--

CREATE TABLE `dbtypes_vocabularies` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dbtypes_vocabularies`
--

INSERT INTO `dbtypes_vocabularies` (`id`, `type_id`, `vocabulary_id`, `weight`) VALUES
(24, 4, 1, NULL),
(25, 4, 2, NULL),
(30, 2, 1, NULL),
(31, 2, 2, NULL);
...
INSERT INTO `dbusers` (`id`, `role_id`, `username`, `password`, `name`, `email`, `website`, `activation_key`, `image`, `bio`, `timezone`, `status`, `updated`, `updated_by`, `created`, `created_by`) VALUES
(1, 1, 'admin', '0c70d181c08d2a35fab4621b26b841d4c1f6c69a', 'admin', '', NULL, 'd05bf8f5cb39d6ce918908578f0a54e7', NULL, NULL, '0', 1, '2014-09-20 15:43:00', NULL, '2014-09-20 15:43:00', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `dbvocabularies`
--

CREATE TABLE `dbvocabularies` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci,
...
--
-- Dumping data for table `dbvocabularies`
--

INSERT INTO `dbvocabularies` (`id`, `title`, `alias`, `description`, `required`, `multiple`, `tags`, `plugin`, `weight`, `updated`, `updated_by`, `created`, `created_by`) VALUES
